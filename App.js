      ...
      <View style={styles.container}>
        <FlatList
          ...
          renderItem={({ item }) => (
            <Button
              title={item.key}
              onPress={() => this.props.navigation.navigate("GridInput")}
            />
          )}
  ...
  return (
    <View>
      <Text style={styles.form}>
        Please input the amount of time you will be at this location
      </Text>
      <View>
        <Text></Text>
        <TextInput placeholder="Length" style={styles.form} />
        <Text></Text>
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Home">
        ...
        <Stack.Screen name="GridInput" component={InputScreen} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
